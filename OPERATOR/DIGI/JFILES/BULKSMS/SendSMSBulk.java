...
public class SendSMSBulk
{
	public static void main(String  gsk [])
	{
		...
		ob.sendSMSBulk("0169697284","VAS220300","IVR","6666817","123456","migseven","hi testing","");

	}
  //===========================================================
  //===========================================================
  public String sendSMSBulk(String ani, String pricecode,String mode,String transid,String refid,String kiword,String msg,String cid)
  {
	  try
	  {
		  System.out.println("SendSMSBulk "+msg.length());
	  ...
	  {
		  System.out.println("Error @ SendSMSBulk "+e);
		  return "ERROR";
	  }
  }//SendSMSBulk ends
}//class ends

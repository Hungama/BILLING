...
import org.apache.activemq.command.ActiveMQTextMessage;
	...
	public class Bulkreciver extends Thread{
		        ...
		        if (message_recv instanceof TextMessage)
		        {
	                ...
	                for(int i=0;i<in_msg.length;i++)
	                {
	                     ...
	                     if("TIVR".equalsIgnoreCase(mode))
	                     	...
	                     	hun_mode="PCN";
	                     else if("TOBD".equalsIgnoreCase(mode)||"OBD".equalsIgnoreCase(mode))
	                     	hun_mode="IVR";
                             else if("HUNOBD".equalsIgnoreCase(mode))
                                hun_mode="IVR";
...
//		System.out.println("retstr---> "+retstr);
		...
		{
			System.out.println("counter -"+i+" value is"+temp[i]);
		}*/
		if(temp[0].equalsIgnoreCase("OK"))
		{
			return (retstr+"#"+amount);
		}
		else if(temp[0].equalsIgnoreCase("NOK") && temp[1].equalsIgnoreCase("-2") && amount.equals("3"))
		{
			...
			if(amount.equals("3"))
			 {
				 amount="1";
				 cpa_sid="Q4sv4jPncR8IMiDLcsWQCA==";
				 retstr= (gsk.ValidateAndBill(ani,"VAS220100",mode,"migseven",cpa_sid)); // try for Ringate 1
				  return (retstr+"#"+amount);
			 }
			 else
			   return (retstr+"#"+amount);
...
//========================================================
	...
	public static void main(String args[])
	{
       ...
       /******************************************************/
		...
		Bulkreciver rBM = new Bulkreciver();
		rBM.start();
	}

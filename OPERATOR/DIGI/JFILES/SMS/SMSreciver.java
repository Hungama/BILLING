...
import org.apache.activemq.command.ActiveMQTextMessage;
	...
	public class SMSreciver extends Thread{
		...
		while(true)
		{
			try
			{
		        ...
		        if (messageQ instanceof TextMessage)
		        {
                	...
                	amount = in_msg[5];
                	 sleep(20);
						...
						else
						{
							...
							response = ob.sendSMS(ani,"VAS220300",dnis,"6666817","123456",mig,message,cp_id);
					...
					//message = message.replaceAll("%20"," ");
					 out_string = "#SMSReceiver#"+msgid+"#"+ani+"#"+message+"#"+date_time+"#"+dnis+"#"+response_time+"#"+response+"#";



               	    message_log.setText("SMSReceiver#"+out_string);

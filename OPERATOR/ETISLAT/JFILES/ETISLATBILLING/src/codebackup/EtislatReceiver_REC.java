...
public class EtislatReceiver_REC extends Thread implements  Gateway
{
	...
	private static String subject_sendid="";
	...
	private static final Logger logger = LoggerFactory.getLogger(EtislatReceiver_REC.class);
	...
	//String delireceipt="deliveryreceipt";
     ...
     static Gateway gateway=null;
		// =======================================================
	public EtislatReceiver_REC(final String remoteIpAddress,final int remotePort, final BindParameter bindParam) throws IOException
	{

		EtislatReceiver_REC.remoteIpAddress = remoteIpAddress;
		EtislatReceiver_REC.remotePort = remotePort;
		EtislatReceiver_REC.bindParam = bindParam;
	...
	public EtislatReceiver_REC()
	{
		...
		public void run()
		{
	        try
	        {
	        	...
	        	ConnectionFactory connectionFactory_sendid = new ActiveMQConnectionFactory(url_send);
...
try
{		
					gateway = new EtislatReceiver_REC("10.71.128.47", 5020, new BindParameter(BindType.BIND_RX, "provectus2", "provec", null, TypeOfNumber.UNKNOWN, NumberingPlanIndicator.UNKNOWN, null));
}
catch(Exception ex)

 ...
 * "application."), today's date (as YYYY-MM-DD) and a suffix (defaults to
 ...
 * in the form of "YYYY-MM-DD") and {@link #tomorrow tomorrow(Calendar calendar)}
...
public class DatedFileAppender extends FileAppender {
    ...
    */
	...
	if (n >= m_tomorrow) {
	    ...
	    File newFile = new File(m_path, datestamp+ m_prefix + m_suffix);

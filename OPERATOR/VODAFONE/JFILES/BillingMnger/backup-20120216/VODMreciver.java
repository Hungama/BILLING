      	 ...
      	 try
		 {
					...
					if("VODM".equalsIgnoreCase(operator))
				    {
				    	 try
				    	 {
								...
								{
									 //chargingURL	= "http://10.22.8.48:7071/SGSM/sgsm?org_id=Hungama&timestamp="+timestamp+"&msisdn=91"+msisdn;
									 //chargingURL	=chargingURL+"&action=act&service=HNG_ENTRMNTPORTAL&class=ENTRMNTPORTAL";

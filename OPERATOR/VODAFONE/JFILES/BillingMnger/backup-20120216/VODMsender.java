...
String qquery = "select billing_ID,msisdn,event_type,amount,service_id,operator,circle,plan_id,MODE,subservice_id from tbl_billing_reqs nolock where status=0 and operator in('VODM')  limit 0,500";//and msisdn in('8699509743','9324963670')
				qquery=qquery.trim();
				//System.out.println(qquery);
				Thread.sleep(1000);
				ResultSet rs= stmt.executeQuery(qquery);

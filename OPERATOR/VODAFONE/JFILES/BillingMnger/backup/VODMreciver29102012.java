      	 ...
      	 try
		 {
					...
					if("VODM".equalsIgnoreCase(operator))
				    {
				    	 try
				    	 {
								...
								{
									 //chargingURL	= "http://10.22.8.48:7071/SGSM/sgsm?org_id=Hungama&timestamp="+timestamp+"&msisdn=91"+msisdn;									 //chargingURL	=chargingURL+"&action=act&service=HNG_ENTRMNTPORTAL&class=ENTRMNTPORTAL";
									 //chargingURL	=chargingURL+"&loginid=HunGamA@&password=MsgHunGama&requestid="+transid+"&mode="+mode;
									...
									mode=mode.toUpperCase();
									 if(mode.indexOf("9XM")>-1 || mode.indexOf("9XT")>-1 || mode.indexOf("MTV")>-1 || mode.indexOf("RFM")>-1||mode.indexOf("9xm")>-1 || mode.indexOf("9xM")>-1  ||mode.indexOf("9Xt")>-1 ||mode.indexOf("9xT")>-1|| mode.indexOf("RFM")>-1 )
										...
										mode="OBD";
									else if(mode.equalsIgnoreCase("IVR-MS") || mode.equalsIgnoreCase("IVR-LBR") || mode.equalsIgnoreCase("IVR-MPMC"))
 										mode="IVR";
									else if(mode.equalsIgnoreCase("USSD-MS"))
										mode="USSD";

									 String response="";
									 chargingURL="http://10.43.248.137/VodafoneBilling/vodafoneMSGBilling.php?msisdn="+msisdn+"&req=act&reqMode="+mode;
								  ...
								  {
									  String response="";
									 chargingURL="http://10.43.248.137/VodafoneBilling/vodafoneOCGBilling.php?msisdn="+msisdn+"&Tcharge="+amount;
									 System.out.println(chargingURL);
									  URL chargrequest = new URL(chargingURL);
									 HttpURLConnection chargingconn = (HttpURLConnection)chargrequest.openConnection();
									 if(chargingconn.getResponseCode()== HttpURLConnection.HTTP_OK)

	...
	public String checkBalence(String msisdn,String operator)
	{
        ...
        String bal="";
       	 ...
       	 try
		 {
				    ...
				    else if("reliance".equalsIgnoreCase(operator))
				    	{
							bal = "100";
						}
...
//=======================================================
	...
	public String chargeBalance(String msisdn,String chargeamt,String operator,String circle)
	{
      	 ...
      	 try
		 {
					...
					if("TATM".equalsIgnoreCase(operator))
				    {
				    	 try
				    	 {
					    	 ...
					    	 chargingURL=chargingURL+msisdn+"&amount="+intchargeamt+"&contentName=54646&chargeReasonType=1";
				    ...
				    {
				    	 String response ="";
				    	 //http://202.138.125.19:8090/cgi-bin/externalrouting/routing.cgi?type=28&appid=236&channelid=2&action=1&mdn=919320617017
				    	 //chargingURL	= "http://202.138.125.19:8090/cgi-bin/externalrouting/routing.cgi?type=28&appid=236&channelid=2&action=1&mdn=";
				    	 chargingURL="http://119.82.69.210/billing/reliance_billing/reliance_billing_interface.php?action=1&mdn=9324963670";
				    	 chargingURL=chargingURL+msisdn+"&amount="+chargeamt;
					     URL chargrequest = new URL(chargingURL);
					     HttpURLConnection chargingconn = (HttpURLConnection)chargrequest.openConnection();
				         if(chargingconn.getResponseCode()== HttpURLConnection.HTTP_OK){
					       BufferedReader in = new BufferedReader(new InputStreamReader(chargingconn.getInputStream()));
			...
			try
			{
		        ...
		        if (message_recv instanceof TextMessage) {
	                ...
	                if("TATM".equalsIgnoreCase(operator))
	                {
						 ...
						 if(Integer.parseInt(useravailbal) <= 0) // low balenced
							 out_string = "NOK#"+billing_ID+"#"+msisdn+"#"+event_type+"#"+useravailbal+"#0#"+amount+"#"+pre_post+"#"+service_id+"#"+setPlan_id+"#nok";
						 else
						 {
							 String[] temp = chargeBalance(msisdn,chargeamt,operator,circle).split("#");
							 trans_id = temp[0];
							 code = temp[1];
							 ...
							 {
								 out_string = "OK#"+billing_ID+"#"+msisdn+"#"+event_type+"#"+useravailbal+"#"+chargeamt+"#"+amount+"#"+pre_post+"#"+service_id+"#"+setPlan_id+"#"+trans_id;
							 }
							 else
							 {
								 out_string = "NOK#"+billing_ID+"#"+msisdn+"#"+event_type+"#"+useravailbal+"#0#"+amount+"#"+pre_post+"#"+service_id+"#"+setPlan_id+"#"+trans_id;
							 }
						 }
						 hunLog(out_string,'t');
...
//else if  (Integer.parseInt(useravailbal) <= Integer.parseInt(chargeamt))
	//out_string = "NOK#"+billing_ID+"#"+msisdn+"#"+event_type+"#"+useravailbal+"#0#"+amount+"#"+pre_post+"#"+service_id+"#"+setPlan_id+"#nok";